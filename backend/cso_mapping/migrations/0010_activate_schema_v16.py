"""Push questionnaire schema v16 live (idempotent; see 0006-0009).

v16 refines the district list: Kweneng East/West become their councils
(Molepolole / Letlhakeng), Mogoditshane-Thamaga is added, and South East is
split into Ramotswa and Tlokweng.
"""
...
def activate(apps, schema_editor):
    ...
    Version.objects.create(
        schema=bundled,
        version_label=label,
        note="Refined district list (Kweneng councils, Mogoditshane-Thamaga, South East split).",
        is_active=True,
    )
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("cso_mapping", "0009_activate_schema_v15"),
    ]
